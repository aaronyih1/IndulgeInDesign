      ...
      React.createElement("div", {className: "nav"}, 
        ...
        React.createElement("table", {style: tableStyle}, 
          React.createElement("tr", null, 
            ...
            React.createElement("td", null, React.createElement("p", {style: descriptionStyle}, "(InDe) is a community of artistically-oriented thinkers and creators obsessed with designing innovative solutions to people’s problems. In order to achieve this goal, InDe cultivates and maintains an environment rich in indulgence of that which the world has to offer, namely: interesting food, places, and experiences. Members will learn to command creativity, innovation, and passion through a tight embrace of spontaneity, uncertainty, and risk—all in the name of anthropocentric design. "))
          ), 
