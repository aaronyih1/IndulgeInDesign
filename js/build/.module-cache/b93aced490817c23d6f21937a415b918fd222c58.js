  ...
  render: function() {
    return (
      React.createElement("div", {className: "nav"}, 
        ...
        React.createElement("img", {src: "imgs/sketchSmall.png", style: sketchStyle}), 
        React.createElement("table", {style: tableStyle}, 
          React.createElement("tr", null, 
            ...
            React.createElement("td", null, React.createElement("p", {style: descriptionStyle}, "(InDe) is an exclusive community of artistically-oriented thinkers and creators obsessed with designing innovative solutions to people’s problems. By cultivating an environment rich in indulgence of interesting food, places, and experiences, members will learn to command creativity, innovation, and passion through a tight embrace of spontaneity, uncertainty, and risk—all in the name of anthropocentric design. "))
          ), 
          ...
          React.createElement("tr", null, 
            ...
            React.createElement("td", null, 
              ...
              React.createElement("p", {style: descriptionStyle}, "All members have completed the ", React.createElement("a", {href: "files/YoungDesignersProgram.pdf", id: "pdfLink"}, "Young Designers Program (YDP)"), " that is designed to communicate the culture of Indulge In Design while also fostering a community of learning and doing. There is no timeline for the process because it is a merit-based program. If you complete all requirements of the program, you become a member. It’s that simple. for an overview of the process.")
            )
          ), 
          React.createElement("tr", {style: rowSpacer}), 
          React.createElement("tr", null, 
